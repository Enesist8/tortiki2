...
using static System.Net.Mime.MediaTypeNames;
            ...
            string[] formtorta = new string[] { "КВАДРАТИК", "ПИРАМИДА", "КРУЖОК" };
            int[] priceformtorta = new int[] { 500, 700, 500 };
            string[] vcus = new string[] { "Шоколадный", "Кремовый", "Ягодный" };
            int[] pricevcus = new int[] { 523, 654, 754 };
            string[] size = new string[] { "16 см ", "24 см", "32 см" };
            int[] pricesize = new int[] { 524, 765, 843 };
            string[] korg = new string[] { "2 коржа", "3 коржа", "4 коржа" };
            int[] pricekorg = new int[] { 500, 700, 900 };
            string[] glasur = new string[] { "шоколад", "крем", "драже" };
            int[] priceglasur = new int[] { 500, 700, 500 };
            string[] decor = new string[] { "Узоры", "Дырочки", "Рисунки" };
                        ...
                        switch (index)
                        {
                            ...
                            case 6:
                                try
                                {
                                    ...
                                    StreamWriter sw = new StreamWriter("C:\\Users\\Enesist)\\Desktop\\тортики.txt", true);
